...
int main(int argc, char *argv[]) {
    ...
    printf("\n# time spend: %fs\n# total query: %d\n# recall: %f\n", (double)(end_time - start_time) / CLOCKS_PER_SEC + total_time, 
        num_query, sum_final_correct * 1.0 / num_query / topk);
    printf("\n# init recall: %f\n# final_length: %f\n", sum_init_correct * 1.0 / num_query / topk, sum_final_length * 1.0 / num_query);    
